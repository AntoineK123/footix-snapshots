...
import FootixLogoBig from "@/assets/footixLogoBig.svg";
  ...
  return (
    <div className="flex flex-col gap-12 px-4 py-10 mx-auto">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="mb-20 mt-5 mx-auto">
          <img src={FootixLogoBig} className="w-120 h-auto" />
        </div>
        ...
        <h1 className="text-3xl font-black leading-tight tracking-tight">
          ...
          <span className="text-yellow-400 italic">& analyse de leur rentabilité</span>
        </h1>
